-- Mirror of supabase/migrations/20260816120000_agent_visit_authenticated_grants.sql
-- Agent Visit console/grant parity. No anon writes. No RLS policy changes.
