                ...
                <div className="flex flex-wrap items-start justify-between gap-2">
                  <div>
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-1.5">
                      ...
                      <StatusBadge variant={orderStatusChipVariant(details.paymentLabel)}>
                    ...
                    {steps.map((step, index) => (
                      <li key={step.key} className="relative flex gap-3 pb-5 last:pb-0">
                        ...
                        <div className="min-w-0 flex-1 pt-0.5">
                          ...
                          {step.timestamp ? (
                            <p className="mt-0.5 text-[10px] text-slate-500">{formatWhen(step.timestamp)}</p>
                          ) : null}
                        </div>
                      </li>
                    ))}
        ...
        <div className="shrink-0 border-t bg-white px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              disabled={repeatLoading || cancelled || !details}
            >
              {repeatLoading ? (
