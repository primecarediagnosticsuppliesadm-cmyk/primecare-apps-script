...
import { PEOPLE_OPS_PAGE_HELP } from "@/peopleOps/peopleOpsBusinessCopy.js";
import { cn } from "@/lib/utils";

/**
 * RC5 — "What does this page do?" help (business language only).
 */
export default function PeopleOpsPageHelp({ moduleId = "dashboard", className }) {
  const help = PEOPLE_OPS_PAGE_HELP[moduleId] || PEOPLE_OPS_PAGE_HELP.dashboard;
