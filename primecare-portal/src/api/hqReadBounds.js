...
export const HQ_V_LABS_CREDIT_LIST_COLUMNS =
  "lab_id,lab_name,tenant_id,area,owner_name,phone,assigned_agent_id,status,ordering_mode,credit_hold,credit_limit,credit_status,days_overdue,outstanding,allowed_overdue_days,sourced_by_agent_id,created_at";
