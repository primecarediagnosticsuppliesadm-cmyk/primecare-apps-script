...
| verify-agent-visit-product-intelligence.mjs | Visit Products & Purchasing step; child table; follow-up persistence; no CRM; wizard runtime import safety (`displayResponseLabel` / unbound callees) | Agent visits |
