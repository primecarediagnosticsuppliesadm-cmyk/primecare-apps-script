...
| verify-agent-visit-evidence-ux.mjs | **VE-3 entry UAT:** Labs Start Visit / Prospect Log Visit must land on fast form; wizard draft skipped on new intent; Add ANALYZER/REAGENT/CONSUMABLE stay fast; **Deep qualification** opens wizard; labeled lab size; no anonymous wallet/evidence Skip; `--remote` QA only; cleanup `[VE-3-CERT]` | Visit Evidence |
