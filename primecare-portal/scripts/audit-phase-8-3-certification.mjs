#!/usr/bin/env node
/** Phase 8.3 workforce planning certification bundle. */
...
const SCRIPTS = [
  ...
  "verify-headcount-planning.mjs",
  "verify-budget-scenarios.mjs",
  "verify-budget-dashboard.mjs",
...
section("Phase 8.3 Workforce Planning certification");
...
console.log("\nOverall: GO — Phase 8.3 certification complete\n");
