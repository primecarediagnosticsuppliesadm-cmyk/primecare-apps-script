#!/usr/bin/env node
/** Phase 8.4 business ownership certification bundle. */
...
const SCRIPTS = [
  ...
  "verify-ownership-tree.mjs",
  "verify-ownership-hierarchy.mjs",
  "verify-territory-ownership.mjs",
  "verify-territory-dashboard.mjs",
  "verify-lab-ownership.mjs",
  "verify-employee-ownership.mjs",
  "verify-compensation-preview-readonly.mjs",
  "verify-read-model-only.mjs",
  ...
  "verify-workforce-budgeting.mjs",
];

let failures = 0;
function section(t) { console.log(`\n=== ${t} ===\n`); }

section("Phase 8.4 Business Ownership certification");
...
console.log("\nOverall: GO — Phase 8.4 certification complete\n");
