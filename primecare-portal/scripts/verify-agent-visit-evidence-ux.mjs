...
const filterFn = access.split("export function filterLabsForUser")[1]?.slice(0, 1400) || "";
assert(!/PROSPECT/.test(filterFn), "ux.filterLabs_unchanged", "filterLabsForUser still has no PROSPECT branch");
...
assert(/Log Visit/.test(labsPage) && /Prospect/.test(labsPage), "ux.labs_prospect_cta", "Labs page prospect Log Visit");
