#!/usr/bin/env node
/**
 * Phase 8.1A People Operations UX certification bundle.
 */
...
const SCRIPTS = [
  ...
  "verify-compensation-dashboard.mjs",
...
section("Phase 8.1A People Operations UX certification");
...
console.log("\nOverall: GO — Phase 8.1A certification complete\n");
